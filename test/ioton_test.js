...
(function() {
  ...
  describe('IOTON', function() {
    ...
    it('It can Stringify and Parse string', function(done) {
      var encoded, iotonStr, json, myType, object, objectOut, schema;
      IOTON.reset();
      object = "hello world";
      schema = "string";
    ...
    it('It can PARSE array of strings', function(done) {
      var encoded, iotonStr, json, myType, object, schema;
      IOTON.reset();
    ...
    it('It can PARSE array of arrays', function(done) {
      var encoded, field, iotonStr, json, myType, object, schema, _i, _len, _ref;
      IOTON.reset();
      object = {
    ...
    it('It can PARSE array of arrays, mismatched schema', function(done) {
      var field, iotonStr, json, object, schema, _i, _len, _ref;
      IOTON.reset();
      object = {
        field1: [[4, 5, 6], [1, 4], [[[[[[[[7]]]]]]], [8]]]
      };
    ...
    it('It can PARSE object with arrays of objects', function(done) {
      var encoded, field, iotonStr, json, myType, object, schema, _i, _j, _len, _len1, _ref, _ref1;
      IOTON.reset();
      object = {
        field1: [
          {
    ...
    it('It can Stringify and Parse a complex object', function(done) {
      var i, iotonStr, json, jsonStr, object, schema, test, _i, _ref;
      IOTON.reset();
      object = {
        field1: "string",
        field2: 2,
    ...
    return it('It can Stringify to and from JSON', function(done) {
      var i, iotonStr, iotonStr2, json, jsonStr, object, schema, _i, _ref;
      IOTON.reset();
      object = {
        field1: "string",
        field2: 2,
      ...
      for (i = _i = 0, _ref = iotonStr.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
