...
(function() {
  ...
  describe('IOTON Run Length Encoding', function() {
    var IOTON;
    IOTON = new ioton();
    it('It can Stringify with RLE and Parse array of strings', function(done) {
      var object, schema;
      IOTON.reset();
    ...
    it('It can Stringify with RLE and Parse object', function(done) {
      var object, schema;
      IOTON.reset();
      object = {
        one: "one",
    ...
    return it('It can do run length encoding', function(done) {
      var object, schema;
      IOTON.reset();
      object = {
        field1: "stuff",
...
//# sourceMappingURL=ioton_rle_test.js.map
