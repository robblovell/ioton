...
This project is [hosted on GitHub](https://github.com/c6o/repo name here). You can clone this project directly using this command:

```
git clone git@github.com:c6o/repo name here.git
```
...
* **[Example Author](https://github.com/[github_handle_here])** - *Initial work* - [CodeZero](https://github.com/c6o)
